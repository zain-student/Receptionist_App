...
export interface NewPatientSnapshotOut extends SnapshotOut<typeof NewPatientModel> {}
export interface NewPatientSnapshotIn extends SnapshotIn<typeof NewPatientModel> {}
