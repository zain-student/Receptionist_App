...
export const PatientAdvanceSearchScreen: FC<PatientStackScreenProps<"PatientAdvanceSearch">> =
  function PatientAdvanceSearchScreen(_props) {
  ...
  function patientItemPress(title: React.SetStateAction<string>) {
    ...
    return (
      <Screen preset="scroll" contentContainerStyle={$container} safeAreaEdges={["top"]}>
        <Text preset="heading" tx="patientAdvanceSearchScreen.searchBy" style={$title} />
