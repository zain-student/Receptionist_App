...
export const EditProfileConsentScreen: FC<
  ProfileStackScreenProps<'EditProfileConsentScreen'>
> = function ProfileEmergencyContact(_props) {
  ...
  return (
    ...
    >
      <Text
        preset="heading"
        tx="patientConsentScreen.patientConsent"
        style={$title}
      />

      <WebView source={{uri: 'https://google.com/'}} style={$webView} />
