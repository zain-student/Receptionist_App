...
import { ToastAndroid, TouchableOpacity, Image, ImageStyle, TextStyle, View, ViewStyle, FlatList } from "react-native"
...
export const CashCollectionScreen: FC<PatientStackScreenProps<"CashCollection">> =
  function CashCollectionScreen(_props) {
    ...
    const [currentPatient, setCurrentPatient] = React.useState(getSelectedPatient())
  ...
  function onServicePress(title){
    ...
    return (
      <Screen preset="fixed" contentContainerStyle={$container} safeAreaEdges={["top"]}>
        <Profile/>
        <Text preset="heading" tx="cashCollectionScreen.cashCollection" style={$title} />
        ...
        <View style={$totalAmountView}>
          ...
          <Text testID="login-heading" 
          // tx={serviceName}
            preset="bold" style={$totalAmountText}>
            {totalAmount}
          </Text>
        </View>
