...
export const OptionsScreen: FC<PatientStackScreenProps<"Options">> =
  function OptionsScreen(_props) {
  ...
  function onServicePress(title){
    ...
    return (
      <Screen preset="scroll" contentContainerStyle={$container} safeAreaEdges={["top"]}>
        ...
        <Text preset="heading" tx="optionsScreen.nextOrSyncData" style={$title} />
        
        <View style={$buttonsView}>
          <Button
            testID="login-button"
            tx={'optionsScreen.selectNextPatient'}
            style={$tapButton}
            preset="reversed"
            onPress={syncDataPress}
          />
        </View>
        <View style={$buttonsView}>
          <Button
            testID="login-button"
            tx={'optionsScreen.syncData'}
            style={$tapButton}
            preset="reversed"
            onPress={syncDataPress}
          />
